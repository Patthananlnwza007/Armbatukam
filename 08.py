...
# อย่าลืม install lib ด้วยนะคับ, ใช้ command นี้ใน cmd หรือ terminal ก็ได้ "pip install pyqrcode pypng pillow"
...
root = Tk()
root.title("QR Generator By Yung56")
canvas = Canvas(root, width=400, height=500)
canvas.pack()

app_label = Label(root, text="QR Generator", font=('Consolas', 20, 'bold', 'underline'))
